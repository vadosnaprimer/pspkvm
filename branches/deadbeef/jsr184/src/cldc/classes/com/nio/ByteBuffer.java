...
public abstract class ByteBuffer extends Buffer {
	...
	/**
	 * This method transfers <code>byte</code>s from this buffer into the
	 * given destination array. Before the transfer, it checks if there are
	 * fewer than length <code>byte</code>s remaining in this buffer.
	 * 
	 * @param dst
	 *            The destination array
	 * @param offset
	 *            The offset within the array of the first <code>byte</code>
	 ...
	 * Where s is the buffer data. Note that the hashcode is dependent on buffer
	...
	public int compareTo(Buffer other) {
		...
		for (int count = 0; count < num; count++) {
			byte a = get(pos_this++);
			byte b = ((ByteBuffer) other).get(pos_other++);
	...
	/**
	 * Writes the <code>byte</code> at this buffer's current position, and
	 * then increments the position.
	 * 
	 * @exception BufferOverflowException
	 *                If there no remaining <code>byte</code>s in this
	 *                buffer.
	 * @exception ReadOnlyBufferException
	 *                If this buffer is read-only.
	 */
...
//	public abstract DoubleBuffer asDoubleBuffer();
	...
	public String toString() {
		return getClass().getName() + "[pos=" + position() + " lim=" + limit()
				+ " cap=" + capacity() + "]";
	}
}
