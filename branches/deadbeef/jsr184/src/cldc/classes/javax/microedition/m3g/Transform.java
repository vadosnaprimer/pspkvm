...
public class Transform {
    ...
    public float[] m =  {1.f,0.f,0.f,0.f,
	0.f,1.f,0.f,0.f,
	0.f,0.f,1.f,0.f,
	0.f,0.f,0.f,1.f};
    ...
    public Transform()
    {
	//it seems that instance initializer improperly initialize m
	setIdentity();
    }
	...
	/*{
	  System.out.println("postmult left matrix:");
	  for(int i=0;i<4;i++){
	  for(int j=0;j<4;j++)
	  System.out.print(l[i*4+j]+" ");
	  System.out.println(" ");
	...
	/*{
	  System.out.println("postmult right matrix:");
	  for(int i=0;i<4;i++){
	  for(int j=0;j<4;j++)
	  System.out.print(r[i*4+j]+" ");
	  System.out.println(" ");
	...
	/*{
	  System.out.println("postmult matrix:");
	  for(int i=0;i<4;i++){
	  for(int j=0;j<4;j++)
	...
	Transform t = new Transform();
	/*{
	  System.out.println("rotation base matrix:");
	  for(int i=0;i<4;i++){
	  for(int j=0;j<4;j++)
	  System.out.print(t.m[i*4+j]+" ");
	  System.out.println(" ");
    ...
    {
	/*{
	  System.out.println("Transform: setGL  matrix:");
	  for(int i=0;i<4;i++){
	  for(int j=0;j<4;j++)
	  System.out.print(m[i*4+j]+" ");
	  System.out.println(" ");
    ...
    {
	/*{
	  System.out.println("Transform: multi matrix:");
	  for(int i=0;i<4;i++){
	  for(int j=0;j<4;j++)
	  System.out.print(m[i*4+j]+" ");
	  System.out.println(" ");
